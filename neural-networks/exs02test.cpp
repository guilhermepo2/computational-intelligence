...
int main()
{
  ...
  Pattern * p1d1 = new Pattern("numbers/damaged/1_d1.txt", 1);
  Pattern * p1d2 = new Pattern("numbers/damaged/1_d2.txt", 1);
  Pattern * p1d3 = new Pattern("numbers/damaged/1_d3.txt", 1);
  Pattern * p1d4 = new Pattern("numbers/damaged/1_d4.txt", 1);
  Pattern * p1d5 = new Pattern("numbers/damaged/1_d5.txt", 1);
  Pattern * p1d6 = new Pattern("numbers/damaged/1_d6.txt", 1);
  Pattern * p1d7 = new Pattern("numbers/damaged/1_d7.txt", 1);
  Pattern * p1d8 = new Pattern("numbers/damaged/1_d8.txt", 1);
  Pattern * p1d9 = new Pattern("numbers/damaged/1_d9.txt", 1);
  Pattern * p1d10 = new Pattern("numbers/damaged/1_d10.txt", 1);
